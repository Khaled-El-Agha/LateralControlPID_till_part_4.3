...
#include "LateralControlPIDPawn.generated.h"
...
UCLASS(config=Game)
class ALateralControlPIDPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	ALateralControlPIDPawn();

	/** The cruise pid control */
	UPROPERTY(Category = Control, EditAnyWhere, BlueprintReadOnly)
	APID* SpeedPIDController;
